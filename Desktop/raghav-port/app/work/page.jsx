...
const projects = [
  {
    ...
    stack: [{ name: "ReactNative" }, { name: "Expo" }, { name: "Firebase" }, {name: "JS_SDK"}, {name: "Node.js"}, {name: "TypeScript"}],
  ...
  },
  {
    ...
    stack: [{ name: "Angular" }, { name: "Node.js" }, { name: "OPEN AI GPT 4" }],
  ...
  },
  {
    ...
    title: "project 3",
    description:
      "Developed a replica of a shopping platform",
  ...
  },
  {
    ...
    stack: [{ name: "Python" }, { name: "Pygame" }, { name: "GUI's" }],
...
const Work = () => {
  ...
  return (
    <motion.section
      ...
      className="min-h-[80vh] flex flex-col justify-center py-12 xl:px-0 mb-44"
    >
